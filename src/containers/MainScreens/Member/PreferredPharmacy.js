...
import { getLocationInfomation, getPreferredPharmacy, setPreferredPharmacy } from "../../../redux/actions/memberActions"
...
export class SelectPharmacy extends React.Component{
    ...
    nextPage = () => {
        ...
        this.props.setPreferredPharmacy({name: this.state.pharmacy_name, address: this.state.pharmacy_address})
    }
    ...
    render(){
        return(
            <Container style={MainStyles.container}>
                <Header 
                    headerText = {"Select Your Preferred Pharmacy"}
                    backURL = {"blank"}
                    backType = {"pop"}
                />
                    <View style={MainStyles.HeaderStyle}>
                        ...
                        {/* <Text style={MainStyles.HeaderText}>Select Your Preferred Pharmacy</Text> */}
                    </View>
                {/* </ImageBackground> */}
                <ScrollView>
                    <View style={[MainStyles.main, {marginLeft: 0, padding: 0, width: LAYOUT.window.width}]}>
                        ...
                        {this.state.lat != 0 && this.state.lon != 0 ? (
                            ...
                            <TouchableOpacity style={[MainStyles.centerStyle, { position: "relative", bottom: 140}]} onPress={() => this.nextPage()}>
                                <Text style={MainStyles.Button}>Update</Text>
                            </TouchableOpacity>
                            </>
...
const mapDispatchToProps = {
    getLocationInfomation, getPreferredPharmacy, setPreferredPharmacy
}
